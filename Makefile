...
SRC = main.cpp Game.cpp Input-Output/fichier.cpp Input-Output/Mouse.cpp Graphique/fonctions_SDL.cpp Input-Output/input.cpp Logique/logique.cpp Logique/Class/Point.cpp Logique/Class/Rectangle.cpp Logique/Class/Ile.cpp Logique/Class/Flotte.cpp Logique/Class/IleBonus.cpp Logique/Class/Navire/Navire.cpp Logique/Class/Navire/Patrouilleur.cpp Logique/Class/Armes_Explosives.cpp Logique/Class/Monde.cpp
OBJ = $(SRC:.cpp=.o)
...
SRCLogique = Logique/Tests/testLogique.cpp Logique/fichier.cpp Logique/logique.cpp Logique/Class/Navire/Patrouilleur.cpp Logique/Class/Rectangle.cpp
OBJLogique = $(SRCLogique:.cpp=.o)

SRCIO = Input-Output/Test/testIO.cpp Input-Output/fichier.cpp Logique/logique.cpp Input-Output/input.cpp Logique/Class/Point.cpp Logique/Class/Rectangle.cpp Logique/Class/Ile.cpp Logique/Class/Flotte.cpp Logique/Class/IleBonus.cpp Logique/Class/Navire/Navire.cpp Logique/Class/Navire/Patrouilleur.cpp Logique/Class/Armes_Explosives.cpp Logique/Class/Monde.cpp 
OBJIO = $(SRCIO:.cpp=.o)
